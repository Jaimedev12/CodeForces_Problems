...
int main() {
    ...
    lli arrEven[n];
    lli arrOdd[n];
    fill(arrEven, arrEven+n, 0);
    fill(arrOdd, arrOdd+n, 0);
    ...
    fore(i, 0, q) {
        ...
        if (a == 0) {
            ...
            lli sumEven = stEven.query(b, c);
            lli sumOdd = stOdd.query(b, c);
            // print("SumEven: " << sumEven << " SumOdd: " << sumOdd);
            lli ans = (b%2 == 0 ? sumEven-sumOdd : sumOdd-sumEven);
            print(ans);
        }
    }
